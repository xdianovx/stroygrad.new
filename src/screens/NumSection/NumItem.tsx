	...
	return (
		<motion.div
			className={cn(
				s.item,
				className,
				'border-t s border-grayBorder group relative last-of-type:border-b cursor-pointer relative z-10 ',
			)}
		...
		>
			<motion.div
				...
				className={cn(
					s.image,
					'absolute w-[317px] h-[392px] right-20 z-[3]  top-1/2 -translate-y-1/2  group-hover:text-white',
				)}
			>
